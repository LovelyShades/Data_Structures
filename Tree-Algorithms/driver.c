...
#define AVL_TEST_VALUE1 27       /* using 27 for smaller testing and 77031 for larger testing */
#define AVL_TEST_VALUE2 77031
...
#define HUFFMAN_TEST_VALUE1 "aabacccadadadadda"
#define HUFFMAN_TEST_VALUE2 "abcdeeeeeeffffffffffff"
...
#define SEGMENT_TEST_VALUE1 "./InputFiles/CTP-Simple01.txt"
#define SEGMENT_TEST_VALUE2 "./InputFiles/CTP-Simple02.txt"
#define SEGMENT_TEST_VALUE3 "./InputFiles/CTP-Simple03.txt"
...
void testAVLTree( int testValue );
...
int main( int argc, char *argv[] )
{
    ...
    testHuffmanEncoding( HUFFMAN_TEST_VALUE1 );
	
    printf("HUFFMAN TREE TEST #2:\n");
    testHuffmanEncoding( HUFFMAN_TEST_VALUE2 );
	
	printf("------------------------------------------------------------------------------\n\n");

    /* test the AVL tree */
    printf("AVL TREE TEST: (testing with %d)\n", AVL_TEST_VALUE1);
    testAVLTree( AVL_TEST_VALUE1 );
	
    printf("AVL TREE TEST: (testing with %d)\n", AVL_TEST_VALUE2);
    testAVLTree( AVL_TEST_VALUE2 );
	
	printf("------------------------------------------------------------------------------\n\n");

    /* test the Segment tree */
    printf("SEGMENT TREE TEST #1:\n");
    testSegmentTree( SEGMENT_TEST_VALUE1 );

    printf("SEGMENT TREE TEST #2:\n");
    testSegmentTree( SEGMENT_TEST_VALUE2 );

    printf("SEGMENT TREE TEST #3:\n");
    testSegmentTree( SEGMENT_TEST_VALUE3 );
...
void testAVLTree( int testValue ){
    ...
    start = clock();
    for( i=testValue; i!=1; i= i%2==0 ? i/2 : i*3+1){
    ...
    if( errorCnt!= 0 )
        printf( "FAILURE - # errors in AVL tree = %d\n" , errorCnt );
    if( dataLostCnt!=0 )
    ...
    if( errorCnt!= 0 )
        ...
        printf( "SUCCESS - No errors in AVL tree detected\n" );
